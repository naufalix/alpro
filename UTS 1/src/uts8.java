...
public class uts8 {
    public static void main(String[] args) {
        ...
        double pt=800000,nt=600000,kt=400000,gk,gp,t,h, gb,tax;
        String nama,nik,np,nj,line2="-------------------------- ";
        ...
        if (jhk>=1&&jhk<=25) {
            if (jp==1&&jj==1) {np="PNS"; nj="Kepala Bagian"; gp=(pk/25)*jhk; t=pt; h=pkh*jhk;
            ...
            else if (jp==1&&jj==2) {np="PNS"; nj="Wakil Kepala Bagian"; gp=(pw/25)*jhk; t=pt; h=pwh*jhk;
                gk=gp+t+h; tax=0.05*gk; gb=gk-tax;
                System.out.println("status  : "+np+" \n"+"Jabatan : "+nj+" \n"+line2);
                System.out.println("Gaji Pokok  : "+gp);
                System.out.println("Tunjangan   : "+t);
            ...
            else if (jp==1&&jj==3) {np="PNS"; nj="Staff"; gp=(ps/25)*jhk; t=pt; h=psh*jhk;
                gk=gp+t+h; tax=0.05*gk; gb=gk-tax;
                System.out.println("status  : "+np+" \n"+"Jabatan : "+nj+" \n"+line2);
                System.out.println("Gaji Pokok  : "+gp);
                System.out.println("Tunjangan   : "+t);
            ...
            else if (jp==2&&jj==1) {np="Tetap Non PNS"; nj="Kepala Bagian"; gp=(nk/25)*jhk; t=nt; h=nkh*jhk;
                gk=gp+t+h; tax=0.05*gk; gb=gk-tax;
                System.out.println("status  : "+np+" \n"+"Jabatan : "+nj+" \n"+line2);
                System.out.println("Gaji Pokok  : "+gp);
                System.out.println("Tunjangan   : "+t);
            ...
            else if (jp==2&&jj==2) {np="Tetap Non PNS"; nj="Wakil Kepala Bagian"; gp=(nw/25)*jhk; t=nt; h=nwh*jhk;
                gk=gp+t+h; tax=0.05*gk; gb=gk-tax;
                System.out.println("status  : "+np+" \n"+"Jabatan : "+nj+" \n"+line2);
                System.out.println("Gaji Pokok  : "+gp);
                System.out.println("Tunjangan   : "+t);
            ...
            else if (jp==2&&jj==3) {np="Tetap Non PNS"; nj="Staff"; gp=(ns/25)*jhk; t=nt; h=nsh*jhk;
                gk=gp+t+h; tax=0.05*gk; gb=gk-tax;
                System.out.println("status  : "+np+" \n"+"Jabatan : "+nj+" \n"+line2);
                System.out.println("Gaji Pokok  : "+gp);
                System.out.println("Tunjangan   : "+t);
            ...
            else if (jp==3&&jj==1) {np="Kontrak"; nj="Kepala Bagian"; gp=(kk/25)*jhk; t=kt; h=kkh*jhk;
                gk=gp+t+h; tax=0.05*gk; gb=gk-tax;
                System.out.println("status  : "+np+" \n"+"Jabatan : "+nj+" \n"+line2);
                System.out.println("Gaji Pokok  : "+gp);
                System.out.println("Tunjangan   : "+t);
            ...
            else if (jp==3&&jj==2) {np="Kontrak"; nj="Wakil Kepala Bagian"; gp=(kw/25)*jhk; t=kt; h=kwh*jhk;
                gk=gp+t+h; tax=0.05*gk; gb=gk-tax;
                System.out.println("status  : "+np+" \n"+"Jabatan : "+nj+" \n"+line2);
                System.out.println("Gaji Pokok  : "+gp);
                System.out.println("Tunjangan   : "+t);
            ...
            else if (jp==3&&jj==3) {np="Kontrak"; nj="Staff"; gp=(ks/25)*jhk; t=kt; h=ksh*jhk;
                gk=gp+t+h; tax=0.05*gk; gb=gk-tax;
                System.out.println("status  : "+np+" \n"+"Jabatan : "+nj+" \n"+line2);
                System.out.println("Gaji Pokok  : "+gp);
                System.out.println("Tunjangan   : "+t);
